...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        """
        self.vars.create_var('v_previous', 0.0)
        self.vars.create_var('pre_v_error', 0.0)
        self.vars.create_var('v_int', 0.0)   # accumulated v_error
        self.vars.create_var('pre_t', 0.0)
        ...
        if self._start_control_loop:
            ...
            dt = t - self.vars.pre_t

            throttle_output = v_error * k_p + self.vars.v_int * dt * k_i + v_diff * k_d / dt
